...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary:
        "bg-[var(--secondary)] text-[var(--text)] hover:opacity-80 focus:ring-[var(--primary)]",
      outline:
        "border-2 border-[var(--primary)] text-[var(--primary)] hover:bg-[var(--secondary)] focus:ring-[var(--primary)]",
      ghost:
        "text-[var(--text)] hover:bg-[var(--secondary)] focus:ring-[var(--primary)]",
    };
