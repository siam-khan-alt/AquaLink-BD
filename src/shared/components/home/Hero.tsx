      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-5 gap-6 items-center">
        ...
        <article className="space-y-10 animate-in fade-in slide-in-from-left duration-1000 col-span-3">
          <header className="space-y-6">
            ...
            <h1 id="hero-heading" className="text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tighter">
          ...
          <p className="text-xl text-white/70 max-w-xl leading-relaxed font-medium">
            <strong className="text-white font-extrabold">AquaLink-BD:</strong> আপনার পুকুরের সাথী। এখন AI প্রযুক্তিতে পুকুর ব্যবস্থাপনা, রোগের সমাধান এবং লাইভ বাজার দর এক ক্লিকেই।
          </p>
          ...
          <nav className="flex flex-wrap gap-5 pt-4">
            ...
            >
              ...
              <MoveRight size={20} className="ml-2 group-hover:translate-x-2 transition-transform" />
            </Button>
        ...
        {/* Right Side */}
        <aside className="relative hidden lg:flex justify-center items-center col-span-2 h-[470px]" aria-hidden="true">
          <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center">
             
             {/* Animation Rings */}
             <div style={{ borderColor: 'var(--primary)' }} className="absolute inset-0 border-2 border-dashed opacity-10 rounded-full animate-[spin_60s_linear_infinite]" />
             <div style={{ borderColor: 'var(--primary)' }} className="absolute inset-12 border opacity-20 rounded-full animate-pulse" />
             <div style={{ borderColor: 'var(--primary)', borderStyle: 'dotted' }} className="absolute inset-24 border-4 opacity-30 rounded-full animate-[spin_20s_linear_infinite_reverse]" />

             <div className="absolute inset-0 animate-[spin_8s_linear_infinite]">
                <div style={primaryBg} className="w-4 h-4 rounded-full absolute top-0 left-1/2 -translate-x-1/2 shadow-[0_0_15px_var(--primary)]" />
             </div>

             {/* Main Logo */}
             <div className="relative w-[300px] h-[300px] group">
                <div style={primaryBg} className="absolute inset-0 opacity-20 rounded-full blur-[80px] group-hover:opacity-40 transition-opacity duration-500" />
