...
export const metadata: Metadata = {
  ...
  description: "AquaLink BD - মৎস্য বন্ধু অ্যাপের মাধ্যমে মাছের বাজার দর জানুন, পুকুর ব্যবস্থাপনা করুন এবং মাছের রোগের সঠিক সমাধান পান দ্রুত।",
  keywords: ["মৎস্য বন্ধু", "AquaLink BD", "মাছ চাষ পদ্ধতি", "মাছের বাজার দর", "মাছের রোগ সমাধান", "Fish Farming Solution"],
  openGraph: {
    title: "মৎস্য বন্ধু - আপনার মাছ চাষের ডিজিটাল সহকারী",
    description: "আধুনিক প্রযুক্তিতে মাছ চাষ করুন লাভজনকভাবে। আজই যুক্ত হোন মৎস্য বন্ধু (AquaLink BD) প্ল্যাটফর্মে।",
